...
// session_start();
// include "koneksi.php";  
include "upload_photo.php"; // Sesuaikan nama file upload anda
...
if (isset($_POST['simpan'])) {
    ...
    // Cek upload gambar
    if ($nama_gambar != '') {
        $cek_upload = upload_photo($_FILES["gambar"]); // Pastikan nama function sesuai
    ...
    // Cek apakah ini Edit (ada ID) atau Tambah Baru (tidak ada ID)
    if (isset($_POST['id'])) {
        // --- LOGIKA UPDATE ---
        $id = $_POST['id'];
        ...
        // Ubah "sssssi" menjadi "ssssi" (5 karakter)
