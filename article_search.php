...
// Ambil keyword, gunakan default string kosong jika tidak ada
...
?>
    <tr>
        ...
        <td>
            <?php
            // Potong isi artikel maksimal 100 karakter agar tabel rapi
            $isi_pendek = mb_strimwidth($row['isi'],     0, 200, "...");
            echo $isi_pendek;
            ?>
        </td>
        ...
        <td>
            ...
            if ($row["gambar"] != '') {
                if (file_exists('img/' . $row["gambar"])) {
                    // Tambahkan style max-width dan max-height
                    echo '<img src="img/' . $row["gambar"] . '" class="img-fluid" style="max-width: 100px; max-height: 100px; object-fit: cover;" alt="Gambar Artikel">';
                }
            }
            ?>
        </td>
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Tuliskan Isi Artikel" name="isi" required rows="5"><?= $row["isi"] ?></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    if ($row["gambar"] != '') {
                                        if (file_exists('img/' . $row["gambar"])) {
                                            echo '<br><img src="img/' . $row["gambar"] . '" class="img-fluid" style="max-height: 100px;" alt="Gambar Artikel">';
                                        }
                                    }
                                    ?>
